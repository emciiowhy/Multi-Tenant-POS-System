...
export const DataGridCard = forwardRef<HTMLButtonElement, DataGridCardProps>(function DataGridCard(
  ...
  return (
    <button
      ...
      className={cn(
        "flex flex-col items-start gap-1 rounded-card border bg-surface p-3 text-left shadow-card",
        "transition-[transform,border-color] motion-safe:hover:scale-[1.01] motion-safe:active:scale-[0.99]",
        "hover:border-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/50",
